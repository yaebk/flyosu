...
The narrative sections that used to open the README, moved here unchanged
when the README was cut down to the current state. They are written in the
order the experiments happened, and several of their claims were later
weakened or corrected by better controls: [`CLAIMS.md`](CLAIMS.md) is the
current statement of what is and is not supported and supersedes anything
here that disagrees with it.

Sections: experiment 1's result, the question the project started from; what
changed when the fly started playing; the full account of experiment 2; and
the build log ("Where this is").
...
**[`docs/RESULTS.md`](RESULTS.md) has the full table, the control-by-control
...
[`docs/CALIBRATION.md`](CALIBRATION.md), "Ongoing activity".
...
**[`docs/RESULTS_E2.md`](RESULTS_E2.md)** has the tables, figures and the
...
**[`docs/RESULTS_E3.md`](RESULTS_E3.md)** — which has since been re-run
...
those experiments used. **[`docs/RESULTS_E4.md`](RESULTS_E4.md).**
...
**[`docs/RESULTS_E6.md`](RESULTS_E6.md).**
...
**[`docs/RESULTS_E7.md`](RESULTS_E7.md).**
...
**[`docs/RESULTS_E8.md`](RESULTS_E8.md).**
...
separation at all.
**[`docs/RESULTS_E9.md`](RESULTS_E9.md).**
...
**[`docs/RESULTS_E5.md`](RESULTS_E5.md).**
...
**[`docs/RESULTS_E10.md`](RESULTS_E10.md).**
...
**[`docs/RESULTS_E11.md`](RESULTS_E11.md).**
...
**[`docs/RESULTS_E12.md`](RESULTS_E12.md).**
...
**[`docs/RESULTS_E13.md`](RESULTS_E13.md).**
...
the controls double.
**[`docs/RESULTS_E14.md`](RESULTS_E14.md)**, protocol in
...
(see [Current status](../README.md#current-status)). Every apparent limit so far has been a
...
the connectome. [`docs/RESULTS_E18.md`](RESULTS_E18.md),
[`docs/RESULTS_E20.md`](RESULTS_E20.md).
...
**[`docs/CLAIMS.md`](CLAIMS.md)** carries the current list claim by claim,
